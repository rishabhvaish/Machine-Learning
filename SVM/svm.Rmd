...
* Write a function to define the objective function (penalized loss). The algorithm may run faster if you further define the gradient function.
...
* Write a function to define the objective function (this should not involve the original $x$, but uses $K$). 
